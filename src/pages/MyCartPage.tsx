        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <Link to="/products" className="group flex items-center space-x-2">
              ...
              <span className="hidden text-sm font-medium text-gray-600 group-hover:text-indigo-600 sm:block">Kembali ke Toko</span>
            </Link>

            <div className="text-center">
              <h1 className="text-lg font-bold text-gray-900">Keranjang Saya</h1>
              <p className="text-xs text-gray-500">Solusi percetakan terbaik untuk Anda</p>
            </div>
            ...
            <div className="flex items-center space-x-1 rounded-full bg-indigo-100 px-3 py-1">
              ...
              <span className="text-sm font-semibold text-indigo-600">{totalQuantity}</span>
            </div>
          </div>
        </div>
      </header>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <span className="rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-600">
                  {productDetails.length} {productDetails.length === 1 ? 'item' : 'item'}
                </span>
              </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-3">
                                ...
                                <div className="flex items-center space-x-1 rounded-full bg-gray-100 p-1">
                                  <button
                                    onClick={() => handleDecreaseQuantity(product.slug)}
                                  ...
                                  <button
                                    onClick={() => handleIncreaseQuantity(product.slug)}
                ...
                <div className="rounded-3xl bg-white p-12 text-center shadow-sm ring-1 ring-gray-100">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gray-100">
                    <svg className="h-8 w-8 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 3h2l.4 2M7 13h10l4-8H5.4m-2.4 0L3 3zM7 13L5.4 7M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H19M17 21a2 2 0 100-4 2 2 0 000 4zM9 21a2 2 0 100-4 2 2 0 000 4z" />
                    </svg>
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900">Keranjang Anda kosong</h3>
                  <p className="mt-1 text-gray-600">Mulai berbelanja untuk menambahkan item ke keranjang.</p>
                  <Link
                    to="/"
          ...
          <div className="space-y-6">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
                <h3 className="mb-6 text-lg font-semibold text-gray-900">Ringkasan Pesanan</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
